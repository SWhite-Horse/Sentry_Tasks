...
//////////////////////////////////////
//#define dYawOffset -0.45//Yaw轴随时间变化的偏移量 秒
...
//float dYawOffsetCalculate(int *StartFlag)//1进入 0不进入 计算一次的偏移量
//{
//	float YawOffset=0;
//	
...
//	   if(HeartbeatCycleIMUCount>1000*360/0.45) HeartbeatCycleIMUCount-=1000*360/0.45;//清零 此公式仅在dYawOffset可整除360时使用
//		IMUYawCompresatation=(float)HeartbeatCycleToTime(&HeartbeatCycleIMUCount)*dYawOffset/1000;//秒为单位,求偏移量
//	  
//	
...
//void Calculateoffset()//dYawOffset算平均值
//{
//	HeartbeatCycleAdd(&HeartbeatCycleIMUCount,&HeartbeatCycleIMUAbsolute);//更新心跳周期
